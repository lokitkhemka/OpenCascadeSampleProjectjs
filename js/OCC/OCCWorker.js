...
var preloadedFonts = ['../../fonts/Roboto.ttf',
  '../../fonts/Papyrus.ttf', '../../fonts/Consolas.ttf', '../../fonts/Debrosee.ttf', '../../fonts/ArianaVioleta.ttf' ];
var fonts = {};
...
new opencascade({
  ...
  // Ping Pong Messages Back and Forth based on their registration in HandleMessage
  onmessage = function (e) {
    let response = HandleMessage[e.data.type](e.data.payload);
...
HandleMessage["Evaluate"] = Evaluate;
...
HandleMessage["CombineAndRenderShapes"] = combineAndRenderShapes;
